...
public class GlobalDefaultExceptionHandler {
	...
	/**
	 * Método para manejar la excepcion ClientDomainException
	 * 
	 * @param e ClientDomainException
	 * @return la excepción en formato Json
	 */
	@ExceptionHandler(ClientDomainException.class)
	@RequestMapping(produces = "application/json")
	@ResponseBody
	public ResponseEntity<ErrorsPayload> handleTodoDomainException(ClientDomainException e) {
